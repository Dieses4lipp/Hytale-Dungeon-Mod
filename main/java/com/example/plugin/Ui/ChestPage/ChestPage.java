...
public class ChestPage extends InteractiveCustomUIPage<ChestPage.Data> {
    ...
    public ChestPage(PlayerRef playerRef) {
    ...
    public void build(@Nonnull Ref<EntityStore> ref,
        ...
        uiCommandBuilder.append("Pages/ChestPage.ui"); // your UI file
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref,
        ...
        if ("close".equals(data.clickedButton)) {
            // page closes automatically on CanDismiss, or handle explicitly
        }
    }
}
