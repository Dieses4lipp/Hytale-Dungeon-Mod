...
public class CharacterPage extends InteractiveCustomUIPage<CharacterPage.Data> {
    public World world;
    public PlayerRef playerRef;

    public CharacterPage(PlayerRef playerRef, World world) {
    ...
    public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder uiCommandBuilder, @Nonnull UIEventBuilder uiEventBuilder, @Nonnull Store<EntityStore> store) {
        uiCommandBuilder.append("Pages/CharacterPage.ui");
var stats = com.example.plugin.Stats.PlayerLevelComponent.getStats(store, ref);
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, Data data) {
        ...
        if (action.equals("nav_market")) { player.getPageManager().openCustomPage(ref, store, new MarketPage(playerRef, world)); }
        if (action.equals("nav_leaderboard")) { player.getPageManager().openCustomPage(ref, store, new LeaderboardPage(playerRef, world)); }
    }
